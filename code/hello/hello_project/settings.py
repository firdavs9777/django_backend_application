...
SECRET_KEY = 'django-insecure-ppd#k66ozq#)f7gwc9_7ncushqvimawqr7i@*f%-+p0x&y4)jr'
...
ALLOWED_HOSTS = [
    ...
    # Add any other hostnames or IPs you need to allow
]
...
INSTALLED_APPS = [
    ...
    'pages.apps.PagesConfig' #Newly Added Pages Application
]
